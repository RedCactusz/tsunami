...
const TIMEOUT_MS = 60_000; // 60 detik untuk routing (loading graph + Dijkstra)
  ...
  affected_villages: [
    {
      ...
      terdampak: 2_975,
      percentage: 70,
      zona_bahaya: "Sangat Tinggi",
      color: "#f87171",
      coordinates: [-7.998, 110.267],
    },
    {
      kelurahan: "Srigading",
      population: 3_820,
...
const MOCK_DESA: DesaData[] = [
  ...
  { name: "Poncosari", lat: -8.049, lon: 110.22 },
...
const MOCK_TES: TESData[] = [
  ...
  {
    id: "TES-08",
    name: "TES Kalurahan Gadingharjo",
    lat: -7.9794643436,
    lon: 110.263849605,
    kapasitas: 500,
  },
  ...
  {
    id: "TES-12",
    name: "TES SD Kanisius Tirtosari",
    lat: -7.99042688197,
    lon: 110.294996955,
    kapasitas: 500,
  },
  {
    id: "TES-13",
    name: "TES Pasar Kuliner Ngangkruk",
    lat: -7.97865334387,
    lon: 110.316386873,
    kapasitas: 500,
  },
  {
    id: "TES-14",
    name: "TES Bukit TPR Parangtritis",
    lat: -7.99669480693,
    lon: 110.315214842,
    kapasitas: 500,
  },
  ...
  {
    id: "TES-16",
    name: "TES Syekh Maulana Maghribi",
    lat: -8.01995453799,
    lon: 110.328169259,
    kapasitas: 500,
  },
...
export async function runSimulation(
  ...
  try {
    ...
    const mockSWE: SWEResult = {
      ...MOCK_SWE_RESULT,
      max_inundation_m: parseFloat(
        (MOCK_SWE_RESULT.max_inundation_m * (0.5 + factor)).toFixed(1),
      ),
      arrival_time_min: Math.round(
        MOCK_SWE_RESULT.arrival_time_min * (1.2 - factor * 0.4),
      ),
      affected_area_km2: parseFloat(
        (MOCK_SWE_RESULT.affected_area_km2 * (0.3 + factor)).toFixed(1),
      ),
    };
...
export async function getFaultList(): Promise<{
  ...
  try {
    ...
    console.warn("[API] /admin/faults gagal, pakai mock data:", err);
    // Fallback ke mock data
    return {
      faults: {
        'opak': { label: 'Sesar Opak', mw: 7.0, category: 'fault', recurrence: '—', view_lat: -7.95, view_lon: 110.41, view_zoom: 11 },
        'lembang': { label: 'Sesar Lembang', mw: 6.8, category: 'fault', recurrence: '—', view_lat: -6.83, view_lon: 107.62, view_zoom: 12 },
        'merapi_merbabu': { label: 'Merapi-Merbabu', mw: 6.8, category: 'fault', recurrence: '—', view_lat: -7.54, view_lon: 110.44, view_zoom: 12 },
        'M9_200yr': { label: 'Java Megathrust Jawa Tengah', mw: 8.7, category: 'megathrust', recurrence: '200 tahun', view_lat: -9.0, view_lon: 110.0, view_zoom: 8 },
      },
      source: 'mock',
      isMock: true
    };
